...
public class CBDD {
    ...
    protected ParametresStockageBDD parametresStockageBDD = null;
    Connection conn = null;
    Statement stmt = null;

    public CBDD(ParametresStockageBDD parametresStockageBDD) {
...
//                conn = DriverManager.getConnection("jdbc:mysql://Localhost:3308/lacoursepourtous", "root", "");
            return true;
   ...
   public static boolean testerConnexion(String nomFichierProperties) {
        CBDD bdd = new CBDD(new ParametresStockageBDD(nomFichierProperties));
    ...
    public ParametresStockageBDD getParametresStockageBDD() {
