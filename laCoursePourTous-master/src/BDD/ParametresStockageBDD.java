...
public final class ParametresStockageBDD {
    ...
    public ParametresStockageBDD(String fichierProperties) {
    ...
    public static void main(String[] args) {
        ...
        //
        ParametresStockageBDD parametresStockageBDD
                = new ParametresStockageBDD("parametresBdd.properties");
