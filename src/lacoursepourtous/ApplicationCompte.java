...
//création du constructeur
    ...
    public User convertir_User (ResultSet rs) {
        try {
            ...
            User user = new User(numeroUtilisateur, nomUtilisateur, prenomUtilisateur, mailUtilisateur, motDePasseUtilisateur);
    ...
    public int ajouterUser(User user) {
        ...
        if (bdd.connecter() == true) {
            String req = "INSERT INTO `compteutilisateur` (`numeroUtilisateur`, `nomUtilisateur`, `prenomUtilisateur`,"
                    + " `mailUtilisateur`, `motDePasseUtilisateur`) "
    ...
    public static void main(String[] args) {
        ...
        User userTest = new User(numeroUtilisateur, nomUtilisateur, prenomUtilisateur, mailUtilisateur, motDePasseUtilisateur);
